    ...
    <>
      <div className="min-h-screen bg-gray-950 w-full ">
        ...
        <div className="flex flex-col w-full mt-3 mx-auto">
          ...
          <div className=" mt-4 ">
            <div className="grid grid-cols-1 gap-y-8 place-content-center md:grid-cols-2 sm:grid-cols-2 mx-10 lg:grid-cols-4 lg:mx-28">
              <div className="w-60 flex flex-col h-40 bg-gray-950 text-white mx-auto rounded-lg mt-1 md:h-48 w-72">
              ...
              <div className="w-5/6 flex flex-col h-40  bg-gray-950 text-white mx-auto rounded-lg mt-1 md:h-48 w-72">
                <div className="flex items-center flex-row h-6">
                  <div className="  w-1/6 img w-4 h-4 ">
                    <img
                      src={blackhole}
